...
import type { Store } from "zephblaze/core";
...
export async function bundleWoff2(store: Store): Promise<Buffer | null> {
    ...
    const woff2 = await svg2woff2(svgs, {
        ...
        ttf_font_opt: {
            version: "1.0",
            description: "fontawesome free font generated by zephblaze from svgs",
            url: "https://github.com/osawa-naotaka/zephblaze.git",
        },
    });
